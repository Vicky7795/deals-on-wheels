      ...
      <main className="flex-1 p-6 lg:p-8 space-y-6 max-w-7xl mx-auto">
        <div className="flex items-center justify-between border-b border-gray-200 pb-4">
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">Updates on your vehicle inquiries and purchase orders</p>
          </div>
        ...
        {loading ? (
          ...
          <EmptyState
            ...
            description="You are all caught up! Updates regarding your inquiries and orders will appear here."
            icon={Bell}
          />
        ) : (
